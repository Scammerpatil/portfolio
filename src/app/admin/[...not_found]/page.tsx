  ...
  return (
    <>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-screen">
        <div className="border border-primary h-[550px] rounded-lg w-full">
          <div className="p-8 flex justify-between bg-primary/20 items-center border-b border-primary/60">
            <div className="block">
              <svg
                width="204"
                height="18"
          ...
          <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
            ...
            <div className="block text-center mt-5">
              <h5 className="md:text-xl text-lg leading-8 text-base-content font-medium mb-1.5">
                <span className="text-primary font-semibold">Oops!</span> It
